...
function Hero3() {
  return (
    <section className='flex justify-center flex-col bg-gray-100 items-center' id='section4'>
      ...
      <div>
        <video className='rounded-lg m-10' width="1000" height="500" controls >
      ...
      <div className='flex flex-wrap items-center justify-center mb-10'>
        <div className='box flex items-center m-2 bg-white'><img alt="" src="https://web-cdn.snapp.ir/snapp-website/images/homepage/180x100-income.png" />
        ...
        <div className='box flex items-center m-2 bg-white'><img alt="" src="https://web-cdn.snapp.ir/snapp-website/images/homepage/180x100-hour.png" />
        ...
        <div className='box flex items-center m-2 bg-white'><img alt="" src="https://web-cdn.snapp.ir/snapp-website/images/homepage/180x100-benefits.png" />
        ...
        <div className='box flex  items-center m-2 bg-white'><img alt="" src="https://web-cdn.snapp.ir/snapp-website/images/homepage/180x100-carfix.png" />
